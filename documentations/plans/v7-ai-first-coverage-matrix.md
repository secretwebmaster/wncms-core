...
- It now demonstrates the v7 reference pattern across transactionally audited backend UI writes, guarded CLI, guarded API v2, and trusted-local read-only MCP. Remaining gaps are guarded API bulk delete and any separately approved mutation MCP contract.
