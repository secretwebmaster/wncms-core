...
构建 admin client 前请阅读 [Sessions](./sessions.md)、[Service tokens](./service-tokens.md)与[安全策略](./security-policy.md)。从 `GET /api/v2/capabilities` 获取 runtime availability；不要硬编码 permissions 或 step-up requirements。
