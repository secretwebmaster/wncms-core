...
<div class="tabs tabs-full">
    ...
    <label for="tab1" class="tab-label">
        ...
        <br />
        {{ trans('installer.environment.wizard.tabs.environment') }}
    </label>
    ...
    <label for="tab2" class="tab-label">
        ...
        <br />
        {{ trans('installer.environment.wizard.tabs.application') }}
    </label>
    ...
    <label for="tab3" class="tab-label">
        ...
        <br />
        {{ trans('installer.environment.wizard.tabs.database') }}
    </label>
    ...
    <form id="form-install-wncms" class="tabs-wrap">
        ...
        <div class="tab" id="tab1content">
            ...
            <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                <label for="app_name">
                    {{ trans('installer.environment.wizard.form.app_name_label') }}
                </label>
                <input type="text" name="app_name" id="app_name" value="{{ old('app_name', 'wncms' . date('YmdHis')) }}" placeholder="{{ trans('installer.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                <label for="app_url">{{ trans('installer.environment.wizard.form.app_url_label') }}</label>
                <input type="url" name="app_url" id="app_url" value="{{ old('app_url', request()->root()) }}" placeholder="{{ trans('installer.environment.wizard.form.app_url_placeholder') }}" />
            ...
            <div class="buttons">
                <button class="button" onclick="showCacheSettings();return false">
                    {{ trans('installer.environment.wizard.form.buttons.setup_database') }}
        ...
        <div class="tab" id="tab2content">
            ...
            <div class="form-group {{ $errors->has('cache_store') ? ' has-error ' : '' }}">
                <label for="cache_store">{{ trans('installer.environment.wizard.form.app_tabs.cache_label') }}</label>
            ...
            <div class="form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                <label for="session_driver">{{ trans('installer.environment.wizard.form.app_tabs.session_label') }}</label>
                <input type="text" name="session_driver" id="session_driver" value="{{ old('session_driver', 'file') }}" placeholder="{{ trans('installer.environment.wizard.form.app_tabs.session_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('redis_hostname') ? ' has-error ' : '' }}">
                <label for="redis_hostname">{{ trans('installer.environment.wizard.form.app_tabs.redis_host') }}</label>
                <input type="text" name="redis_hostname" id="redis_hostname" value="127.0.0.1" placeholder="{{ trans('installer.environment.wizard.form.app_tabs.redis_host') }}" />
            ...
            <div class="form-group {{ $errors->has('redis_password') ? ' has-error ' : '' }}">
                <label for="redis_password">{{ trans('installer.environment.wizard.form.app_tabs.redis_password') }}</label>
                <input type="password" name="redis_password" id="redis_password" value="" placeholder="{{ trans('installer.environment.wizard.form.app_tabs.redis_password_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('redis_port') ? ' has-error ' : '' }}">
                <label for="redis_port">{{ trans('installer.environment.wizard.form.app_tabs.redis_port') }}</label>
                <input type="number" name="redis_port" id="redis_port" value="6379" placeholder="{{ trans('installer.environment.wizard.form.app_tabs.redis_port') }}" />
        ...
        <div class="tab" id="tab3content">
            ...
            <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="database_hostname" id="database_hostname" value="{{ old('database_hostname', '127.0.0.1') }}" placeholder="{{ trans('installer.environment.wizard.form.db_host_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                ...
                <input type="number" name="database_port" id="database_port" value="{{ old('database_port', '3306') }}" placeholder="{{ trans('installer.environment.wizard.form.db_port_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="database_name" id="database_name" value="{{ old('database_name') }}" placeholder="{{ trans('installer.environment.wizard.form.db_name_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="database_username" id="database_username" value="{{ old('database_username') }}" placeholder="{{ trans('installer.environment.wizard.form.db_username_placeholder') }}" />
            ...
            <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                ...
                <input type="password" name="database_password" id="database_password" value="{{ old('database_password') }}" placeholder="{{ trans('installer.environment.wizard.form.db_password_placeholder') }}" />
