...
<span class="badge badge-success">@lang('wncms::word.' . ((object)$model)->{$status_attribute ?? 'status'})</span>
...
<span class="badge badge-warning">@lang('wncms::word.' . ((object)$model)->{$status_attribute ?? 'status'})</span>
...
<span class="badge badge-danger">@lang('wncms::word.' . ((object)$model)->{$status_attribute ?? 'status'})</span>

@else
<span class="badge badge-secondary">@lang('wncms::word.' . ((object)$model)->{$status_attribute ?? 'status'})</span>
