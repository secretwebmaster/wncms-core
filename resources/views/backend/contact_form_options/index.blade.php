                ...
                <table class="table table-hover align-middle text-nowrap mb-0">
                    <thead class="table-dark">
                        <tr class="text-start fw-bold gs-0">
                            ...
                            <th>@lang('wncms::word.display_name')</th>
                            <th>@lang('wncms::word.placeholder')</th>
                            <th>@lang('wncms::word.default_value')</th>
                            <th>@lang('wncms::word.options')</th>
                    ...
                    <tbody id="table_with_checks" class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-dark fw-bold px-2 py-1" href="{{ route('contact_form_options.edit' , $contact_form_option) }}">@lang('wncms::word.edit')</a>
                                @include('wncms::backend.parts.modal_delete' , ['model'=>$contact_form_option , 'route' => route('contact_form_options.destroy' , $contact_form_option), 'btn_class' => 'px-2 py-1'])
                            </td>
