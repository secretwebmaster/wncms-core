        ...
        <div class="card">
            <div class="card-header border-0 cursor-pointer px-3 px-md-9">
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">@lang('wncms::word.create_website')</h3>
                </div>
            </div>
            ...
            <div class="collapse show">
                <form class="form" method="POST" action="{{ route('websites.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body border-top p-3 p-md-9">
                        ...
                        {{-- License --}}
                        {{-- <div class="row mb-3">
                            <label class="col-lg-4 col-form-label fw-bold fs-6">@lang('wncms::word.license')</label>
                        ...
                        {{-- Theme --}}
                        <div class="row mb-6">
                            <label class="col-lg-12 col-form-label  fw-bold fs-6">@lang('wncms::word.theme')</label>
                            <div class="col-lg-12 fv-row">
