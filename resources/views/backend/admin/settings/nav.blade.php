<div class="col-12 col-sm-4 col-lg-2">
    <div class="card bg-dark text-gray-100">
        <div class="card-body px-3 py-3 py-md-8">
            <div class="wncms-settings-nav-scroll">
            <ul class="nav nav-tabs nav-pills border-0 flex-row flex-md-column me-0 me-md-5 mb-0 mb-md-0 fs-6 w-100 wncms-settings-nav-list">
                ...
                <li class="nav-item fw-bold me-0 wncms-settings-nav-item">
                    <a class="nav-link {{ $activeTab === 'api_access' ? 'active' : '' }}" data-bs-toggle="tab" data-bs-target="#tab_api_access" href="javascript:void(0);">
                ...
                @if(gss('developer_mode'))
                    <li class="nav-item fw-bold me-0 wncms-settings-nav-item">
                        <a class="nav-link {{ $activeTab === 'developer' ? 'active' : '' }}" data-bs-toggle="tab" data-bs-target="#tab_{{ 'developer' }}" href="javascript:void(0);">
