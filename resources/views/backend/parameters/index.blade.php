    ...
    <div class="wncms-toolbar-buttons mb-5">
        <div class="card-toolbar flex-row-fluid gap-1">
            ...
            @include('wncms::backend.common.default_toolbar_buttons', [
                'model_prefix' => 'parameters',
            ])
        </div>
    </div>

    {{-- Index --}}
    @include('wncms::backend.common.showing_item_of_total', ['models' => $parameters])
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" data-model-id="{{ $parameter->id }}"/>
                                    </div>
                                </td>
                                {{-- Actions --}}
                                <td>
                                    <a class="btn btn-sm btn-dark fw-bold px-2 py-1" href="{{ route('parameters.edit' , $parameter) }}">@lang('wncms::word.edit')</a>
                                    @include('wncms::backend.parts.modal_delete' , ['model'=>$parameter , 'route' => route('parameters.destroy' , $parameter), 'btn_class' => 'px-2 py-1'])
                                </td>
