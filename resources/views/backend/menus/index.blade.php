                    ...
                    <form action="{{ route('menus.clone') }}" method="POST" id="form_clone_menu">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">@lang('wncms::word.clone_menu')</h3>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="form-item mb-5">
                                    <label class="form-label">@lang('wncms::word.select_options')</label>
                                    <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                        ...
                                        <label class="form-check-label" for="create_page_if_not_exists">@lang('wncms::word.create_page_if_not_exists')</label>
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary fw-bold"
                                    ...
                                    data-success-text="@lang('wncms::word.submit')"
                ...
                <table class="table table-hover align-middle text-nowrap mb-0">
                    ...
                    <tbody id="table_with_checks" class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm px-2 py-1 btn-dark fw-bold" href="{{ route('menus.edit' , $menu) }}">@lang('wncms::word.edit')</a>
