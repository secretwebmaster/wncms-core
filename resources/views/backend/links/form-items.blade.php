<div class="card-body border-top p-3 p-md-9">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-9 fv-row">
            <input id="expired_at" name="expired_at" value="{{ !empty($link->expired_at) ? $link->expired_at->format('Y-m-d H:i:s') : '' }}" class="form-control form-control-sm" placeholder="@lang('wncms::word.choose_date_or_leave_blank')" id="date_expired_at" />
        </div>
        <script>
            window.addEventListener('DOMContentLoaded', (event) => {
