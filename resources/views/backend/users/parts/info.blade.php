                ...
                <div class="d-flex justify-content-center align-items-start flex-wrap mb-2 ">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <a href="#" class="btn btn-sm btn-light-primary border border-1 border-primary fw-bold ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">{{ auth()->user()->active_subscription->plan?->name ?? __('wncms::word.free_plan') }}</a>
                        </div>
