<button type="button" class="btn btn-sm btn-primary px-2 py-1 fw-bold" data-bs-toggle="modal" data-bs-target="#recharge_user_{{ $user->id }}">@lang('wncms::word.recharge')</button>
        ...
        <form action="{{ route('users.recharge.admin', $user) }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">@lang('wncms::word.recharge_for_this')</h3>
                </div>
    
                <div class="modal-body">
                    <div class="form-item mb-6">
                        <label>@lang('wncms::word.username')</label>
                        <input class="form-control" type="text" value="{{ $user->username }}" disabled>
                    </div>
                    <div class="form-item mb-6">
                        <label>@lang('wncms::word.email')</label>
                        <input class="form-control" type="text" value="{{ $user->email }}" disabled>
                    </div>
                    <div class="form-item mb-6">
                        <label>@lang('wncms::word.amount')</label>
