            ...
            <div class="mb-3">
                ...
                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap align-items-center">
                    <div class="mb-3 mb-md-0 fw-semibold flex-grow-1">
                        <div class="fs-6 text-gray-700 pe-7 fw-bold">
                            <input id="user-api-token" class="form-control w-100" type="text" value="{{ auth()->user()->api_token }}" disabled>
                        </div>
                    </div>
                    <button
                        type="button"
                        class="btn btn-primary px-6 align-self-center text-nowrap fw-bold"
                        btn-copy-to-clipboard
                        data-value="{{ auth()->user()->api_token }}"
                    ...
                    <div class="card-header pt-5">
                        ...
                        {{-- <div class="card-toolbar">
                            <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" data-kt-daterangepicker-range="today" class="btn btn-sm btn-light d-flex align-items-center px-4" data-kt-initialized="1">
                                <div class="text-gray-600 fw-bold">5 Jul 2023</div>
...
<script>
    ...
    const colors = [
        { border: "red",   background: "rgba(255,99,132,0.2)" },
        { border: "blue",  background: "rgba(54,162,235,0.2)" },
        { border: "green", background: "rgba(75,192,192,0.2)" },
        { border: "orange", background: "rgba(255,159,64,0.2)" },
        { border: "purple", background: "rgba(153,102,255,0.2)" },
    ];

    const datasets = datasetsRaw.map((item, index) => {
