...
<div class="card">
    <div class="card-header border-0 cursor-pointer px-3 px-md-9 bg-dark">
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0 text-gray-100">{{ wncms()->getModelWord('theme','edit') }}</h3>
        </div>
    </div>
    ...
    <div class="collapse show">
        <form class="form" method="POST" action="{{ route('themes.update', $theme) }}" enctype="multipart/form-data">
            ...
            <div class="card-body border-top p-3 p-md-9">
                    ...
                    <div class="col-lg-9 fv-row">
                        <select name="status" class="form-select form-select-sm" required>
                            @foreach($statuses as $key => $value)
                                <option  value="{{ $value }}" {{ $value === $theme?->status ? 'selected' :'' }}><b>@lang('wncms::word.' . $value)</b></option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                {{-- system --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label  fw-bold fs-6">@lang('wncms::word.system')</label>
                    <div class="col-lg-9 fv-row">
                        <select name="system" class="form-select form-select-sm" required>
                            <option value="">@lang('wncms::word.please_select')</option>
                            @foreach($systems as $system)
                                <option  value="{{ $system }}" {{ $system === $theme?->system ? 'selected' :'' }}><b>@lang('wncms::word.' . $system)</b></option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                {{-- path --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label fw-bold fs-6">@lang('wncms::word.path')</label>
                    <div class="col-lg-9 fv-row">
                ...
                {{-- demo_url --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label fw-bold fs-6">@lang('wncms::word.demo_url')</label>
                    <div class="col-lg-9 fv-row">
                ...
                {{-- version --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label fw-bold fs-6">@lang('wncms::word.version')</label>
                    <div class="col-lg-9 fv-row">
                ...
                {{-- demo_content --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label fw-bold fs-6">@lang('wncms::word.demo_content')</label>
                    <div class="col-lg-9 fv-row">
                ...
                {{-- plugins --}}
                <div class="row mb-3">
                    <label class="col-lg-3 col-form-label fw-bold fs-6">@lang('wncms::word.plugins')</label>
                    <div class="col-lg-9 fv-row">
