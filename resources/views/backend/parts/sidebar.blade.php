<div id="wncms_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#wncms_app_sidebar_mobile_toggle">
	...
	<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
		<div id="wncms_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#wncms_app_sidebar_logo, #wncms_app_sidebar_footer" data-kt-scroll-wrappers="#wncms_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
			<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#wncms_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
	...
	{{-- Sidebar Footer --}}
	<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="wncms_app_sidebar_footer">
