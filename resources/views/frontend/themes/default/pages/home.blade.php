...
@section('content')
    ...
    {{-- Pages --}}
    @include('wncms::frontend.themes.default.parts.page-list')

    {{-- Posts --}}
    @include('wncms::frontend.themes.default.parts.post-list')

    {{-- Tags --}}
    @include('wncms::frontend.themes.default.parts.tag-list')

    {{-- Webstie options --}}
    @include('wncms::frontend.themes.default.parts.website-options')
    
    {{-- Thenme options --}}
    @include('wncms::frontend.themes.default.parts.theme-options')

    {{-- Links --}}
    @include('wncms::frontend.themes.default.parts.link-list')
@endsection
