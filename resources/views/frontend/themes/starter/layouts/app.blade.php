...
<html lang="{{ str_replace("_", "-", wncms()->locale()->getCurrentLocale()) }}" dir="ltr">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset("themes/starter/css/style.css") . $wncms->addVersion('css') }}" />
        @stack('head_css')
    ...
    <body itemtype="https://schema.org/WebPage" itemscope="itemscope" class="@stack('body_class')">
        ...
        @include('frontend.themes.starter.parts.header')

        @yield('content')

        @include('frontend.themes.starter.parts.footer')
